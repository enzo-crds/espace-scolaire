      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Field label="Note obtenue">
            <input type="number" step={0.25} className={inputClass} value={value} onChange={(e) => setValue(Number(e.target.value))} />
          </Field>
          <Field label="Sur (barème)">
            <input type="number" step={0.5} className={inputClass} value={maxValue} onChange={(e) => setMaxValue(Number(e.target.value))} />
          </Field>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Field label="Coefficient">
            <input type="number" step={0.5} min={0.5} className={inputClass} value={coefficient} onChange={(e) => setCoefficient(Number(e.target.value))} />
          </Field>
          <Field label="Date">
